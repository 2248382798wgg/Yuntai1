<template>
<uni-shadow-root class="dist-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="'z-index: '+(zIndex)+';'" @click.native="onTap">
